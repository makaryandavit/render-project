...
const ProsAndCons = () => {
  ...
  return (
    <div className={styles.container}>
      ...
      <main>
        <PartCreator title="Pros" arrayOfItems={listsPros} editingIndex={editingProIndex} placeholderValue={"Write Your Pros"} setEditText={setEditingText} editText={editingText} setEditingIndex={setEditingProIndex} setLists={setListsPros} />

        <PartCreator title="Cons" arrayOfItems={listsCons} editingIndex={editingConIndex} placeholderValue={"Write Your Cons"} setEditText={setEditingText} editText={editingText} setEditingIndex={setEditingConIndex} setLists={setListsCons} />
      </main>
    </div>
  );
};
